...
$isLoggedIn = isset($_SESSION['user_id']); // Ajusta la clave según lo que uses para almacenar la sesión del usuario
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="./../style/style_tick.css"/>
    ...
    <body>
            ...
            <div class="menu">
                <nav>
                    <ul>
                        ...
                        <hr/>
                        <li><a href="./html/updates.html">UPDATES</a></li>
                        <hr/>
                        <li><a href="./ticketing.php">TIKET</a></li>
                    </ul>
                </nav>
            </div>
            <div class="login">
        ...
        <main>
            <div class="ticket-container">
                ...
                <p>¿Necesitas ayuda? Abre un tiket y nuestro equipo te responderá lo antes posible.</p>
                
                <div class="ticket-button-container">
                    <button id="open-ticket" class="ticket-button">
                        <span>
                          <a href="./ticket.html" class="boton">
                            Abrir Tiket
                          </a>
                        </span>
                ...
                <div class="ticket-info">
                    <div class="info-box">
                        <h3><span>🕒</span> Respuesta rápida</h3>
                        <p>Nuestro equipo responde en menos de 24 horas.</p>
                    </div>
                    <div class="info-box">
                        <h3><span>🔒</span> Seguro y confidencial</h3>
                        <p>Tus datos están protegidos en todo momento.</p>
                    </div>
                    <div class="info-box">
                        <h3><span>👨‍💻</span> Soporte especializado</h3>
                        <p>Expertos en resolver tus problemas técnicos.</p>
                    </div>
                </div>
            </div>
        </main>
        ...
        <footer>
            <div class="footer-container">
                ...
                <div class="footer-links-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="./newsletters.html">Boletines</a></li>
                        <li><a href="#">Blog</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <p class="copyright">© 2023 iTiket. Todos los derechos reservados.</p>
        ...
        <script src="./../JS/script_tick.js"></script>
